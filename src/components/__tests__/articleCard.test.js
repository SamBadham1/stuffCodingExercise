...
const article = {
  ...
  story: {
    ...
    intro:
      'Guy Wallace, one of the last people to see Ben Smart and Olivia Hope alive, has died in a suspected suicide at his West Coast home.',
    section: 'National',
    images: [
      {
        type: 'Defcon Image',
        ...
        caption:
          'Guy Wallace is the water taxi driver who delivered Ben Smart and Olivia Hope to  yacht in Endeavour Inlet early on New Years day. Marlborough Express pic PIC IN OTHER NEWS PAPERS FOLDER.2/12/98.',
      },
      {
        type: 'Splash Image',
        size: '400x300',
      ...
      },
      {
        ...
        caption:
          'Wallace was one of the last people to see Smart and Hope alive.',
      },
      {
        type: 'Standard Image',
        size: '349x620',
        ...
        caption:
          'Scott Watson was convicted of the murders of Smart and Hope, and was sentenced to life in prison with a minimum parole period of 17 years.',
      },
      {
        type: 'Standard Image',
        size: '349x620',
        ...
        caption:
          'Wallace has died in a suspected suicide at his home on Fernhill Place in Greymouth.',
      },
    ],
  },
};
test('should render article headline', () => {
  render(<ArticleCardComponent articleSingle={article}></ArticleCardComponent>);
  const linkElement = screen.getByText(/Sounds murder/i);
  expect(linkElement).toBeInTheDocument();
});

test('should render article intro', () => {
  render(<ArticleCardComponent articleSingle={article}></ArticleCardComponent>);
  const linkElement = screen.getByText(/Guy Wallace, one of the last people/i);
  expect(linkElement).toBeInTheDocument();
});
